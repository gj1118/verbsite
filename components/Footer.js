export default function Footer() {
  return (
    <footer
      ...
      data-wow-delay=".1s"
    >
      <div className="ud-py-8 ud-bg-primary ud-bg-opacity-10">
        <div className="ud-container">
          <p
            ...
            "
          >
            &copy; {new Date().getFullYear()} GaganJ.com. All rights reserved.
          </p>
        </div>
      </div>
      <div className="ud-absolute ud-right-0 ud-top-14 ud-z-[-1]">
        <svg
          width="55"
          height="99"
          viewBox="0 0 55 99"
      ...
      <div className="ud-absolute ud-left-0 ud-bottom-24 ud-z-[-1]">
        <svg
          width="79"
          height="94"
          viewBox="0 0 79 94"
